# Topology 3 — Direct SIP-to-E1 RAS Validation

This topology removes the HT503 and its analog FXS/FXO segment from the
slmodem-to-RAS call path. It is intended to distinguish behavior caused by
the analog ATA conversion from behavior of the slmodem, SIP/RTP transport, or
the AS5300.
...
| V.34 | Pass | 33,600/33,600 bit/s | 3/3 | Clean call using SIP/RTP ports 5072/4024. |
